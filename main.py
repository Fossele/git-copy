...
init_parser.add_argument(
    "path", nargs="?", default=".", help="Enter a path to initialise."
)
# init_parser.add_argument("")
...
add_parser.add_argument(
    "-a",
    "--all",
    help="Stages all changes in the entire repository,egardless of your current directory.",
)
add_parser.add_argument("filename", nargs="+", help="stages all given files.")

hash_parser = subparser.add_parser("hash-object")
hash_parser.add_argument(
    "-w", dest="write", help="write the object into the object database."
)
hash_parser.add_argument(
    "-t",
    metavar="type",
